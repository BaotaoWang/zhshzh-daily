...
public class GenerateMapperFileUtil {
    ...
    private static void generateWhereClause(StringBuilder builder) {
        ...
        builder.append("        <foreach collection=\"conditionList\" item=\"item\" index=\"index\" >").append("\r\n");
        builder.append("          <choose>").append("\r\n");
        builder.append("            <when test=\"item.whereConditionEnum.condition == 'OR_START'\" >").append("\r\n");
        builder.append("              AND ((1 = 1").append("\r\n");
        builder.append("            </when>").append("\r\n");
        builder.append("            <when test=\"item.whereConditionEnum.condition == 'OR'\" >").append("\r\n");
        builder.append("              ) OR (1 = 1").append("\r\n");
        builder.append("            </when>").append("\r\n");
        builder.append("            <when test=\"item.whereConditionEnum.condition == 'OR_END'\" >").append("\r\n");
    ...
    private static void generateSelectByConditionsSql(String tableName, String tableComment, String upperCamelCaseTableName,
        ...
        builder.append("        LIMIT #{limitFrom}, #{limitNumber}").append("\r\n");
        builder.append("      </when>").append("\r\n");
        builder.append("      <when test=\"limitNumber != null and limitNumber != 0\">").append("\r\n");
        builder.append("        LIMIT #{limitNumber}").append("\r\n");
        builder.append("      </when>").append("\r\n");
        builder.append("    </choose>").append("\r\n");
        builder.append("  </select>").append("\r\n");
    }
